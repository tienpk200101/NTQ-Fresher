...
<!-- Mirrored from themesbrand.com/velzon/html/galaxy/apps-ecommerce-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Feb 2023 02:12:11 GMT -->
<head>
                    ...
                    <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                        <div data-simplebar style="max-height: 320px;">
                            ...
                            <div class="dropdown-item bg-transparent text-wrap">
                                <a href="{{ route('home') }}" class="btn btn-soft-primary btn-sm btn-rounded">how to setup <i class="mdi mdi-magnify ms-1"></i></a>
                                <a href="{{ route('home') }}" class="btn btn-soft-primary btn-sm btn-rounded">buttons <i class="mdi mdi-magnify ms-1"></i></a>
                            </div>
                            <!-- item-->
                    ...
                    <div class="row mb-3">
                        <div class="col-xl-8">
                            ...
                            <div class="text-end mb-4">
                                <a href="{{ route('checkout.show') }}" class="btn btn-primary btn-label right ms-auto"><i class="ri-arrow-right-line label-icon align-bottom fs-16 ms-2"></i> Checkout</a>
                            </div>
                        </div>
                        <!-- end col -->
...
<!-- Mirrored from themesbrand.com/velzon/html/galaxy/apps-ecommerce-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Feb 2023 02:12:12 GMT -->
</html>