...
<body>
    ...
    <!-- Quick view -->
    @include('clients.layouts.modal')
    @include('clients.layouts.header-area')
    @include('clients.layouts.navbar-mobile')
    <!--End header-->
    <main class="main">
                ...
                <div class="home-slide-cover mt-30">
                    <div class="hero-slider-1 style-4 dot-style-1 dot-style-1-position-1">
                        <div class="single-hero-slider single-animation-wrap"
                            style="background-image: url(assets_2/imgs/slider/slider-1.png)">
                        ...
                        <div class="single-hero-slider single-animation-wrap"
                            style="background-image: url(assets_2/imgs/slider/slider-2.png)">
                            <div class="slider-content">
                                <h1 class="display-2 mb-40">
                    ...
                    <div class="carausel-10-columns" id="carausel-10-columns">
                        <div class="card-2 bg-9 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="assets_2/imgs/shop/cat-13.png"
                                        alt="" /></a>
                            </figure>
                        ...
                        <div class="card-2 bg-10 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="assets_2/imgs/shop/cat-12.png"
                                        alt="" /></a>
                            </figure>
                        ...
                        <div class="card-2 bg-11 wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="assets_2/imgs/shop/cat-11.png"
                                        alt="" /></a>
                            </figure>
                        ...
                        <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="assets_2/imgs/shop/cat-9.png"
                                        alt="" /></a>
                            </figure>
                        ...
                        <div class="card-2 bg-13 wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="assets_2/imgs/shop/cat-3.png"
                                        alt="" /></a>
                            </figure>
                        ...
                        <div class="card-2 bg-14 wow animate__animated animate__fadeInUp" data-wow-delay=".6s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="assets_2/imgs/shop/cat-1.png"
                                        alt="" /></a>
                            </figure>
                        ...
                        <div class="card-2 bg-15 wow animate__animated animate__fadeInUp" data-wow-delay=".7s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="assets_2/imgs/shop/cat-2.png"
                                        alt="" /></a>
                            </figure>
                        ...
                        <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay=".8s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="assets_2/imgs/shop/cat-4.png"
                                        alt="" /></a>
                            </figure>
                        ...
                        <div class="card-2 bg-10 wow animate__animated animate__fadeInUp" data-wow-delay=".9s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="assets_2/imgs/shop/cat-5.png"
                                        alt="" /></a>
                            </figure>
                        ...
                        <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay="1s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="assets_2/imgs/shop/cat-14.png"
                                        alt="" /></a>
                            </figure>
                        ...
                        <div class="card-2 bg-11 wow animate__animated animate__fadeInUp" data-wow-delay="0s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="assets_2/imgs/shop/cat-15.png"
                                        alt="" /></a>
                            </figure>
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            <div class="product-card-bottom">
                                                <div class="product-price">
                                                    <span>VND {{ $product['price'] }}</span><br/>
                                                    <span class="old-price">VND {{ $product['old_price'] }}</span>
                                                </div>
                                                <div class="add-cart">
                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="assets_2/imgs/shop/product-10-1.jpg"
                                                    alt="" />
                                                <img class="hover-img" src="assets_2/imgs/shop/product-10-2.jpg"
                                                    alt="" />
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="assets_2/imgs/shop/product-12-1.jpg"
                                                    alt="" />
                                                <img class="hover-img" src="assets_2/imgs/shop/product-12-2.jpg"
                                                    alt="" />
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="assets_2/imgs/shop/product-13-1.jpg"
                                                    alt="" />
                                                <img class="hover-img" src="assets_2/imgs/shop/product-13-2.jpg"
                                                    alt="" />
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="assets_2/imgs/shop/product-14-1.jpg"
                                                    alt="" />
                                                <img class="hover-img" src="assets_2/imgs/shop/product-14-2.jpg"
                                                    alt="" />
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="assets_2/imgs/shop/product-15-1.jpg"
                                                    alt="" />
                                                <img class="hover-img" src="assets_2/imgs/shop/product-15-2.jpg"
                                                    alt="" />
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="assets_2/imgs/shop/product-16-1.jpg"
                                                    alt="" />
                                                <img class="hover-img" src="assets_2/imgs/shop/product-16-2.jpg"
                                                    alt="" />
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="assets_2/imgs/shop/product-7-1.jpg"
                                                    alt="" />
                                                <img class="hover-img" src="assets_2/imgs/shop/product-7-2.jpg"
                                                    alt="" />
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="assets_2/imgs/shop/product-8-1.jpg"
                                                    alt="" />
                                                <img class="hover-img" src="assets_2/imgs/shop/product-8-2.jpg"
                                                    alt="" />
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="assets_2/imgs/shop/product-9-1.jpg"
                                                    alt="" />
                                                <img class="hover-img" src="assets_2/imgs/shop/product-9-2.jpg"
                                                    alt="" />
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="assets_2/imgs/shop/product-6-1.jpg"
                                                    alt="" />
                                                <img class="hover-img" src="assets_2/imgs/shop/product-6-2.jpg"
                                                    alt="" />
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="assets_2/imgs/shop/product-5-1.jpg"
                                                    alt="" />
                                                <img class="hover-img" src="assets_2/imgs/shop/product-5-2.jpg"
                                                    alt="" />
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="assets_2/imgs/shop/product-4-1.jpg"
                                                    alt="" />
                                                <img class="hover-img" src="assets_2/imgs/shop/product-4-2.jpg"
                                                    alt="" />
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="assets_2/imgs/shop/product-3-1.jpg"
                                                    alt="" />
                                                <img class="hover-img" src="assets_2/imgs/shop/product-3-2.jpg"
                                                    alt="" />
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="assets_2/imgs/shop/product-2-1.jpg"
                                                    alt="" />
                                                <img class="hover-img" src="assets_2/imgs/shop/product-2-2.jpg"
                                                    alt="" />
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6 d-none d-xl-block">
                                <div class="product-cart-wrap">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="assets_2/imgs/shop/product-1-1.jpg"
                                                    alt="" />
                                                <img class="hover-img" src="assets_2/imgs/shop/product-1-2.jpg"
                                                    alt="" />
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="assets_2/imgs/shop/product-11-1.jpg"
                                                    alt="" />
                                                <img class="hover-img" src="assets_2/imgs/shop/product-11-2.jpg"
                                                    alt="" />
                                            </a>
                                        </div>
                                        <div class="product-action-1">
            ...
            <div class="row">
                    ...
                    <div class="product-list-small animated animated">
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href="shop-product-right.html"><img src="assets_2/imgs/shop/thumbnail-1.jpg"
                                        alt="" /></a>
                            </figure>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href="shop-product-right.html"><img src="assets_2/imgs/shop/thumbnail-2.jpg"
                                        alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href="shop-product-right.html"><img src="assets_2/imgs/shop/thumbnail-3.jpg"
                                        alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-md-0 wow animate__animated animate__fadeInUp"
                    ...
                    <div class="product-list-small animated animated">
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href="shop-product-right.html"><img src="assets_2/imgs/shop/thumbnail-4.jpg"
                                        alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href="shop-product-right.html"><img src="assets_2/imgs/shop/thumbnail-5.jpg"
                                        alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href="shop-product-right.html"><img src="assets_2/imgs/shop/thumbnail-6.jpg"
                                        alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-sm-5 mb-md-0 d-none d-lg-block wow animate__animated animate__fadeInUp"
                    ...
                    <div class="product-list-small animated animated">
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href="shop-product-right.html"><img src="assets_2/imgs/shop/thumbnail-7.jpg"
                                        alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href="shop-product-right.html"><img src="assets_2/imgs/shop/thumbnail-8.jpg"
                                        alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href="shop-product-right.html"><img src="assets_2/imgs/shop/thumbnail-9.jpg"
                                        alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-sm-5 mb-md-0 d-none d-xl-block wow animate__animated animate__fadeInUp"
                    ...
                    <div class="product-list-small animated animated">
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href="shop-product-right.html"><img src="assets_2/imgs/shop/thumbnail-10.jpg"
                                        alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href="shop-product-right.html"><img src="assets_2/imgs/shop/thumbnail-11.jpg"
                                        alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href="shop-product-right.html"><img src="assets_2/imgs/shop/thumbnail-12.jpg"
                                        alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
