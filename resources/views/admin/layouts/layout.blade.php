...
<!-- Mirrored from themesbrand.com/velzon/html/galaxy/apps-ecommerce-products.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Feb 2023 02:10:31 GMT -->
<head>
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ route('admin.list_category.show') }}" class="nav-link" data-key="t-calendar"> List Category
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.add_category.show') }}" class="nav-link" data-key="t-chat"> Add Category </a>
                            </li>
                        </ul>
                    </div>
                </li>
...
<!-- Mirrored from themesbrand.com/velzon/html/galaxy/apps-ecommerce-products.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Feb 2023 02:11:26 GMT -->
</html>
