    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <!-- end page title -->
                <form action="{{ route('admin.product_edit.post', $product->id) }}" method="POST" id="updateproduct-form" autocomplete="off" class="needs-validation"
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('title') is-invalid @enderror" id="product-title-input" name="title"
                                               value="{{ $product->title }}" placeholder="Enter product title" required>
                                        @error('title')
                                    ...
                                    <div>
                                        ...
                                        <textarea id="ckeditor-classic" name="description"
                                                  class="@error('description') is-invalid @enderror">{!! $product->description !!}</textarea>
                                        @error('description')
                                        <div class="text text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control @error('stock') is-invalid @enderror" id="stocks-input"
                                                               value="{{ $product->stock }}" name="stock" placeholder="Stocks" required>
                                                        @error('stock')
                                                        <div class="text text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group has-validation mb-3">
                                                            ...
                                                            <input type="number" class="form-control @error('regular_price') is-invalid @enderror"
                                                                   id="product-price-input" value="{{ $product->regular_price }}" name="regular_price" placeholder="Enter price"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="number" class="form-control @error('discount') is-invalid @enderror"
                                                                   id="product-discount-input" value="{{ $product->discount }}" name="discount"
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('order') is-invalid @enderror" id="orders-input"
                                                               value="{{ $product->order }}" name="order" placeholder="Orders" required>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active">
                                            <div class="row">
                                                <div class="col-lg-3 col-sm-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="is_attr-no">No Attribute Variable</label>
                                                        <input type="radio" class="@error('is_attr') is-invalid @enderror" id="is_attr-no"
                                                               value="0" name="is_attr" {{ $product->is_attr == 0 ? 'checked' : '' }}>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-sm-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="is_attr-add">Add Attribute Variable</label>
                                                        <input type="radio" class="@error('is_attr') is-invalid @enderror"
                                                               id="is_attr-add" value="1" name="is_attr" {{ $product->is_attr == 1 ? 'checked' : '' }}>
                                                    </div>
                                                </div>
                                                <!-- end col -->
                                            </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <textarea class="form-control" name="short_description" placeholder="Must enter minimum of a 100 characters" rows="3">{!! $product->short_description !!}</textarea>
                                </div>
                                <!-- end card body -->
                            </div>
                            <!-- end card -->
