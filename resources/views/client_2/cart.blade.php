                    ...
                    <table class="table table-bordered text-center mb-0">
                        ...
                        @foreach(session()->get('cart') as $key => $product)
                            <tr class="item-cart-product-{{ $key }}">
                                <td class="align-middle d-flex justify-content-between"><img src="{{ $product['image'] }}" alt=""
                                ...
                                <td class="align-middle">
                                    <div class="input-group quantity mx-auto input-step" style="width: 100px;">
                                        ...
                                        <input type="text" class="form-control form-control-sm bg-secondary text-center product-quantity"
