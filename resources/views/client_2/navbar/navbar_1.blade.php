                    ...
                    @else
                        <div class="dropdown">
                            <a class="btn btn-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user"
                                     ...
                                     alt="Header Avatar" width="30px">
                            </a>
                            <span class="text-start ms-xl-2 ml-2">
                                    <span class="d-none d-xl-inline-block ms-1 fw-semibold user-name-text">
                                        {{ Auth::guard('customer')->user()->full_name ?? Auth::guard('customer')->user()->username }}
                                    </span>
                            </span>
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                ...
                                <a class="dropdown-item" href="{{ route('logout') }}">Logout <i
                                        class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i></a>
                            </div>
                        </div>
                    @endguest
                </div>
